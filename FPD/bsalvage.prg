...
*       º                                                         º
*       º 07/16/03            BSALVAGE.SPR               17:58:53 º
*       º                                                         º
...
*       ÖÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ·
*       º                                                         º
*       º         BSALVAGE/MS-DOS Setup Code - SECTION 1          º
*       º                                                         º
*       ÓÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ½
*
...
IF NOT WEXIST("_rn60r8lzq") ;
	OR UPPER(WTITLE("_RN60R8LZQ")) == "_RN60R8LZQ.PJX" ;
	OR UPPER(WTITLE("_RN60R8LZQ")) == "_RN60R8LZQ.SCX" ;
	OR UPPER(WTITLE("_RN60R8LZQ")) == "_RN60R8LZQ.MNX" ;
	OR UPPER(WTITLE("_RN60R8LZQ")) == "_RN60R8LZQ.PRG" ;
	OR UPPER(WTITLE("_RN60R8LZQ")) == "_RN60R8LZQ.FRX" ;
	OR UPPER(WTITLE("_RN60R8LZQ")) == "_RN60R8LZQ.QPR"
...
*       ÖÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ·
*       º                                                         º
*       º         BSALVAGE/MS-DOS Setup Code - SECTION 2          º
*       º                                                         º
*       ÓÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ½
*
...
*       ÖÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ·
*       º                                                         º
*       º              BSALVAGE/MS-DOS Screen Layout              º
*       º                                                         º
*       ÓÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ½
*
...
@ 15,34 SAY "Scan Quality:" ;
	...
	COLOR N+/W    
@ 15,20 GET ScanRecs ;
	PICTURE "@*VN Scan good;Skip bad;Auto Scan" ;
	SIZE 1,11,0 ;
	DEFAULT 1 ;
	VALID SCANRECS()
@ 16,32 GET SensLvl ;
...
*       ÖÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ·
*       º                                                         º
*       º              BSALVAGE/MS-DOS Cleanup Code               º
*       º                                                         º
*       ÓÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ½
*
...
*       ÖÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ·
*       º                                                         º
*       º  BSALVAGE/MS-DOS Supporting Procedures and Functions    º
*       º                                                         º
*       ÓÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ½
*
...
IF LEN(BlockArray[BlockCount+1])<20 && this is a right hand entry - previous entry was left
  IF (FilePos - VAL(LEFT(BlockArray[BlockCount+1],11))) % recordlen !=0;
    ...
    ?? CHR(7)
    =MessageBox("Block Start/End record positions do not match"+CHR(13)+"(or incorrect .def file)!", 0, "Notice:")
    RETURN .T.
  ENDIF
...
FOR ii = 1 TO BCx
  IF VAL(LEFT(BlockArray[ii+1],11))<=FilePos AND;
    ...
    ?? CHR(7)
    =MessageBox("Selected position overlaps a file block!", 0, "Notice:")
    RETURN .T.
  ENDIF
ENDFOR
RETURN .F.
...
IF MessageBox("This changes the '" + OldChar + "' character to '" + NewChar;
    + "'. Original character may be lost if you change your mind!" + CHR(13)  + CHR(13) + "Continue?", 1, "Notice:")==2
  RETURN
ENDIF
...
*       ÖÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ·
*       º                                                         º
*       º INSTRSV           Instrs VALID                          º
*       º                                                         º
*       º Function Origin:                                        º
*       º                                                         º
*       º From Platform:       MS-DOS                             º
*       º From Screen:         BSALVAGE,     Record Number:   11  º
*       º Variable:            Instrs                             º
...
IF !Empty(HelpPath)
  ...
  IF FileHandle > 0
    TempNo=SrchFile(FileHandle, INT(TempNo/3), TempNo, "4.10 vFPS")
    InstrStr = ''
    TempS=FGETS(FileHandle)
    DO WHILE ATC("5.0", TempS)==0 AND !FEOF(FileHandle)
  ...
  ENDIF
ENDIF
=MessageBox("Could not find MANUAL.TXT file. vFPS instructions are in section 4.10 of the file or in the printed manual!", 0, "Notice!")


*       ÖÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ·
*       º                                                         º
*       º SCANRECS           ScanRecs VALID                       º
*       º                                                         º
*       º Function Origin:                                        º
*       º                                                         º
*       º From Platform:       MS-DOS                             º
*       º From Screen:         BSALVAGE,     Record Number:   26  º
*       º Variable:            ScanRecs                           º
*       º Called By:           VALID Clause                       º
*       º Object Type:         Push Button                        º
  ...
  IF LEN(TempS2)==RecordLen && !FEOF
    IF (LEN(TempS)>0 AND ScanRecs == 1) && scan good records until bad found
      * warning or error record found
      ...
      =WaitWin()
      =FilePosV()
      =MessageBox(TempS + " in next record!", 0, "Notice:")
      RETURN
    ENDIF
    IF LEN(TempS)==0 AND ScanRecs == 2 && scan to good record
      * good record found
      ...
      =WaitWin()
      =FilePosV()
      =MessageBox("This record appears OK", 0, "Notice:")
      RETURN
    ENDIF
  ENDIF
...
*       ÖÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ·
*       º                                                         º
*       º BSALVAGEW           Read Level When                     º
*       º                                                         º
*       º Function Origin:                                        º
*       º                                                         º
*       º                                                         º
*       º From Platform:       MS-DOS                             º
*       º From Screen:         BSALVAGE                           º
